    ...
    <DropDown
      ...
      <DropDownItem
        ...
        <div className="icon-text-container">
          ...
          <span className="text">체크리스트</span>
        </div>
    ...
    <DropDown
      ...
      <DropDownItem
        ...
        <div className="icon-text-container">
          ...
          <span className="text">양쪽 맞춤</span>
        </div>
            ...
            <>
              ...
              <DropDown
                ...
                <DropDownItem
                  ...
                  <span className="text">페이지 나누기</span>
                </DropDownItem>
                <DropDownItem
                  onClick={() => {
                ...
                <DropDownItem
                  ...
                  <span className="text">Excalidraw (드로잉)</span>
                </DropDownItem>
                <DropDownItem
                  onClick={() => {
                ...
                <DropDownItem
                  ...
                  <span className="text">단 나누기</span>
                </DropDownItem>
                ...
                <DropDownItem
                  ...
                  <span className="text">접을 수 있는 컨테이너</span>
                </DropDownItem>
                <DropDownItem
                  onClick={() => {

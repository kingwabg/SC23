...
export function getDynamicOptions(editor: LexicalEditor, queryString: string) {
  ...
  if (tableMatch !== null) {
    ...
    options.push(
      ...colOptions.map(
        (columns) =>
          new ComponentPickerOption(`${rows}x${columns} 표`, {
...
export function getBaseOptions(editor: LexicalEditor, showModal: ShowModal) {
  return [
    new ComponentPickerOption('본문 (Paragraph)', {
    ...
    ...([1, 2, 3] as const).map(
      (n) =>
        new ComponentPickerOption(`제목 (Heading) ${n}`, {
    ...
    new ComponentPickerOption('표 (Table)', {
      icon: <i className="icon table" />,
    ...
    new ComponentPickerOption('체크리스트', {
      icon: <i className="icon check" />,
      keywords: ['check list', 'todo list'],
      onSelect: () =>
        editor.dispatchCommand(INSERT_CHECK_LIST_COMMAND, undefined),
    }),
    new ComponentPickerOption('인용문', {
    ...
    new ComponentPickerOption('페이지 나누기', {
      icon: <i className="icon page-break" />,
      keywords: ['page break', 'divider'],
      onSelect: () => editor.dispatchCommand(INSERT_PAGE_BREAK, undefined),
    }),
    new ComponentPickerOption('Excalidraw (드로잉)', {
      icon: <i className="icon diagram-2" />,
      keywords: ['excalidraw', 'diagram', 'drawing'],
      onSelect: () =>
        editor.dispatchCommand(INSERT_EXCALIDRAW_COMMAND, undefined),
    }),
    new ComponentPickerOption('투표', {
    ...
    ...EmbedConfigs.map(
      (embedConfig) =>
        new ComponentPickerOption(`${embedConfig.contentName} 임베드`, {
    ...
    new ComponentPickerOption('접을 수 있는 컨테이너', {
      icon: <i className="icon caret-right" />,
      keywords: ['collapse', 'collapsible', 'toggle'],
      onSelect: () =>
        editor.dispatchCommand(INSERT_COLLAPSIBLE_COMMAND, undefined),
    }),
    new ComponentPickerOption('단 나누기 (Columns Layout)', {
    ...
    ...(['left', 'center', 'right', 'justify'] as const).map(
      (alignment) =>
        new ComponentPickerOption(`${alignment} 정렬`, {

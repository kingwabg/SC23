  ...
  return createPortal(
    ...
    <div
      ...
      <button
        ...
        <span className="text">배경 색상</span>
      </button>
      <button
        type="button"
        className="item"
        ...
        <span className="text">줄무늬 행 전환</span>
      </button>
      <DropDown
        buttonLabel="수직 정렬"
      ...
      <button
        ...
        <span className="text">첫 행 고정 전환</span>
      </button>
      <button
        type="button"
        className="item"
        ...
        <span className="text">첫 열 고정 전환</span>
      </button>
      <hr />
      <button
        type="button"
